...
const labels:Record<Locale,{home:string;collections:string;language:string;menu:string;close:string;choose:string}>={
  en:{home:'Home',collections:'Categories',language:'Language',menu:'Menu',close:'Close menu',choose:'Choose a category'},
  pt:{home:'Início',collections:'Categorias',language:'Idioma',menu:'Menu',close:'Fechar menu',choose:'Escolha uma categoria'},
  es:{home:'Inicio',collections:'Categorías',language:'Idioma',menu:'Menú',close:'Cerrar menú',choose:'Elige una categoría'},
  zh:{home:'首页',collections:'分类',language:'语言',menu:'菜单',close:'关闭菜单',choose:'选择一个分类'},
  hi:{home:'होम',collections:'श्रेणियाँ',language:'भाषा',menu:'मेनू',close:'मेनू बंद करें',choose:'एक श्रेणी चुनें'}
};
...
export default function Header({locale}:{locale:Locale}){
  ...
  return <header className="site-header stream-header">
    ...
    <nav className="desktop-nav"><Link href={`/${locale}/`}>{l.home}</Link><Link href={`/${locale}/#collections`}>{l.collections}</Link></nav>
