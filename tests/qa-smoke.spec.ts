...
async function startCase(page: Page, number: '001' | '002' | '003' | '003' | '003') {
...
async function startCaseWithRealClock(page: Page, number: '001' | '002' | '003' | '003' | '003') {
...
async function startCaseWithMockClock(page: Page, number: '001' | '002' | '003' | '003' | '003') {
