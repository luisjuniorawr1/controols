...
test('streaming catalog keeps one cinematic featured story plus four adventure tiles', async ({ page }) => {
...
test('four-story streaming catalog remains fully usable on a phone viewport', async ({ page }) => {
